...
package CM_FW_INFO_CTRL is
  type CM_FW_INFO_BUILD_DATE_MON_t is record
    DAY                        :std_logic_vector( 7 downto 0);
    MONTH                      :std_logic_vector( 7 downto 0);
    YEAR                       :std_logic_vector(15 downto 0);
  end record CM_FW_INFO_BUILD_DATE_MON_t;


  type CM_FW_INFO_BUILD_TIME_MON_t is record
    SEC                        :std_logic_vector( 7 downto 0);
    MIN                        :std_logic_vector( 7 downto 0);
    HOUR                       :std_logic_vector( 7 downto 0);
  end record CM_FW_INFO_BUILD_TIME_MON_t;


  type CM_FW_INFO_MON_t is record
    GIT_VALID                  :std_logic;   
    ...
    BUILD_DATE                 :CM_FW_INFO_BUILD_DATE_MON_t;  
    BUILD_TIME                 :CM_FW_INFO_BUILD_TIME_MON_t;  
  end record CM_FW_INFO_MON_t;




end package CM_FW_INFO_CTRL;