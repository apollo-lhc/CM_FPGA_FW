...
package K_C2C_INTF_CTRL is
  type K_C2C_INTF_C2C_DRP_MOSI_t is record
    clk       : std_logic;
    enable    : std_logic;
    wr_enable : std_logic;
    address   : std_logic_vector(10-1 downto 0);
    wr_data   : std_logic_vector(16-1 downto 0);
  end record K_C2C_INTF_C2C_DRP_MOSI_t;
  type K_C2C_INTF_C2C_DRP_MISO_t is record
    rd_data         : std_logic_vector(16-1 downto 0);
    rd_data_valid   : std_logic;
  end record K_C2C_INTF_C2C_DRP_MISO_t;
  constant Default_K_C2C_INTF_C2C_DRP_MOSI_t : K_C2C_INTF_C2C_DRP_MOSI_t := ( 
                                                     clk       => '0',
                                                     enable    => '0',
                                                     wr_enable => '0',
                                                     address   => (others => '0'),
  ...
  type K_C2C_INTF_C2C_STATUS_MON_t is record
  ...
  end record K_C2C_INTF_C2C_STATUS_MON_t;


  type K_C2C_INTF_C2C_STATUS_CTRL_t is record
    INITIALIZE                 :std_logic;     -- C2C initialize
  end record K_C2C_INTF_C2C_STATUS_CTRL_t;


  constant DEFAULT_K_C2C_INTF_C2C_STATUS_CTRL_t : K_C2C_INTF_C2C_STATUS_CTRL_t := (
                                                                                   INITIALIZE => '0'
                                                                                  );
  type K_C2C_INTF_C2C_DEBUG_RX_MON_t is record
  ...
  end record K_C2C_INTF_C2C_DEBUG_RX_MON_t;


  type K_C2C_INTF_C2C_DEBUG_RX_CTRL_t is record
  ...
  end record K_C2C_INTF_C2C_DEBUG_RX_CTRL_t;


  constant DEFAULT_K_C2C_INTF_C2C_DEBUG_RX_CTRL_t : K_C2C_INTF_C2C_DEBUG_RX_CTRL_t := (
                                                                                       BUF_RESET => '0',
                                                                                       CDR_HOLD => '0',
                                                                                       DFE_LPM_RESET => '0',
                                                                                       LPM_EN => '1',
  ...
  type K_C2C_INTF_C2C_DEBUG_TX_MON_t is record
    BUF_STATUS                 :std_logic_vector( 1 downto 0);  -- DEBUG tx buf status
    RESET_DONE                 :std_logic;                      -- DEBUG tx reset done
  end record K_C2C_INTF_C2C_DEBUG_TX_MON_t;


  type K_C2C_INTF_C2C_DEBUG_TX_CTRL_t is record
  ...
  end record K_C2C_INTF_C2C_DEBUG_TX_CTRL_t;


  constant DEFAULT_K_C2C_INTF_C2C_DEBUG_TX_CTRL_t : K_C2C_INTF_C2C_DEBUG_TX_CTRL_t := (
                                                                                       INHIBIT => '0',
                                                                                       PCS_RESET => '0',
                                                                                       PMA_RESET => '0',
                                                                                       POLARITY => '0',
  ...
  type K_C2C_INTF_C2C_DEBUG_MON_t is record
    ...
    RX                         :K_C2C_INTF_C2C_DEBUG_RX_MON_t;
    TX                         :K_C2C_INTF_C2C_DEBUG_TX_MON_t;
  end record K_C2C_INTF_C2C_DEBUG_MON_t;


  type K_C2C_INTF_C2C_DEBUG_CTRL_t is record
    ...
    RX                         :K_C2C_INTF_C2C_DEBUG_RX_CTRL_t;
    TX                         :K_C2C_INTF_C2C_DEBUG_TX_CTRL_t;
  end record K_C2C_INTF_C2C_DEBUG_CTRL_t;


  constant DEFAULT_K_C2C_INTF_C2C_DEBUG_CTRL_t : K_C2C_INTF_C2C_DEBUG_CTRL_t := (
                                                                                 EYESCAN_RESET => '0',
                                                                                 EYESCAN_TRIGGER => '0',
                                                                                 PCS_RSV_DIN => (others => '0'),
                                                                                 RX => DEFAULT_K_C2C_INTF_C2C_DEBUG_RX_CTRL_t,
                                                                                 TX => DEFAULT_K_C2C_INTF_C2C_DEBUG_TX_CTRL_t
                                                                                );
  type K_C2C_INTF_C2C_COUNTERS_MON_t is record
  ...
  end record K_C2C_INTF_C2C_COUNTERS_MON_t;


  type K_C2C_INTF_C2C_COUNTERS_CTRL_t is record
    RESET_COUNTERS             :std_logic;     -- Reset counters in Monitor
  end record K_C2C_INTF_C2C_COUNTERS_CTRL_t;


  constant DEFAULT_K_C2C_INTF_C2C_COUNTERS_CTRL_t : K_C2C_INTF_C2C_COUNTERS_CTRL_t := (
                                                                                       RESET_COUNTERS => '0'
                                                                                      );
  type K_C2C_INTF_C2C_MON_t is record
    DRP                        :K_C2C_INTF_C2C_DRP_MISO_t;
    STATUS                     :K_C2C_INTF_C2C_STATUS_MON_t;
    DEBUG                      :K_C2C_INTF_C2C_DEBUG_MON_t; 
    COUNTERS                   :K_C2C_INTF_C2C_COUNTERS_MON_t;
    USER_FREQ                  :std_logic_vector(31 downto 0);  -- Measured Freq of clock
  end record K_C2C_INTF_C2C_MON_t;
  type K_C2C_INTF_C2C_MON_t_ARRAY is array(1 to 2) of K_C2C_INTF_C2C_MON_t;

  type K_C2C_INTF_C2C_CTRL_t is record
    DRP                        :K_C2C_INTF_C2C_DRP_MOSI_t;
    STATUS                     :K_C2C_INTF_C2C_STATUS_CTRL_t;
    DEBUG                      :K_C2C_INTF_C2C_DEBUG_CTRL_t; 
    COUNTERS                   :K_C2C_INTF_C2C_COUNTERS_CTRL_t;
  ...
  end record K_C2C_INTF_C2C_CTRL_t;
  type K_C2C_INTF_C2C_CTRL_t_ARRAY is array(1 to 2) of K_C2C_INTF_C2C_CTRL_t;

  constant DEFAULT_K_C2C_INTF_C2C_CTRL_t : K_C2C_INTF_C2C_CTRL_t := (
                                                                     DRP => Default_K_C2C_INTF_C2C_DRP_MOSI_t,
                                                                     STATUS => DEFAULT_K_C2C_INTF_C2C_STATUS_CTRL_t,
                                                                     DEBUG => DEFAULT_K_C2C_INTF_C2C_DEBUG_CTRL_t,
                                                                     COUNTERS => DEFAULT_K_C2C_INTF_C2C_COUNTERS_CTRL_t,
  ...
  type K_C2C_INTF_PB_MEM_MOSI_t is record
    clk       : std_logic;
    enable    : std_logic;
    wr_enable : std_logic;
    address   : std_logic_vector(11-1 downto 0);
    wr_data   : std_logic_vector(18-1 downto 0);
  end record K_C2C_INTF_PB_MEM_MOSI_t;
  type K_C2C_INTF_PB_MEM_MISO_t is record
    rd_data         : std_logic_vector(18-1 downto 0);
    rd_data_valid   : std_logic;
  end record K_C2C_INTF_PB_MEM_MISO_t;
  constant Default_K_C2C_INTF_PB_MEM_MOSI_t : K_C2C_INTF_PB_MEM_MOSI_t := ( 
                                                     clk       => '0',
                                                     enable    => '0',
                                                     wr_enable => '0',
                                                     address   => (others => '0'),
  ...
  type K_C2C_INTF_PB_MON_t is record
    MEM                        :K_C2C_INTF_PB_MEM_MISO_t;
  end record K_C2C_INTF_PB_MON_t;


  type K_C2C_INTF_PB_CTRL_t is record
    MEM                        :K_C2C_INTF_PB_MEM_MOSI_t;
    RESET                      :std_logic;               
    IRQ_COUNT                  :std_logic_vector(31 downto 0);
  end record K_C2C_INTF_PB_CTRL_t;


  constant DEFAULT_K_C2C_INTF_PB_CTRL_t : K_C2C_INTF_PB_CTRL_t := (
                                                                   MEM => Default_K_C2C_INTF_PB_MEM_MOSI_t,
                                                                   RESET => '0',
                                                                   IRQ_COUNT => x"00989680"
                                                                  );
  type K_C2C_INTF_MON_t is record
    C2C                        :K_C2C_INTF_C2C_MON_t_ARRAY;
    PB                         :K_C2C_INTF_PB_MON_t;       
  end record K_C2C_INTF_MON_t;


  type K_C2C_INTF_CTRL_t is record
    C2C                        :K_C2C_INTF_C2C_CTRL_t_ARRAY;
    PB                         :K_C2C_INTF_PB_CTRL_t;       
  end record K_C2C_INTF_CTRL_t;


  constant DEFAULT_K_C2C_INTF_CTRL_t : K_C2C_INTF_CTRL_t := (
                                                             C2C => (others => DEFAULT_K_C2C_INTF_C2C_CTRL_t ),
                                                             PB => DEFAULT_K_C2C_INTF_PB_CTRL_t
                                                            );


end package K_C2C_INTF_CTRL;