...
begin  -- architecture behavioral
  ...
  -------------------------------------------------------------------------------
  -------------------------------------------------------------------------------
  assert ((4*17) <= ALLOCATED_MEMORY_RANGE)
    report "CM_FW_INFO: Regmap addressing range " & integer'image(4*17) & " is outside of AXI mapped range " & integer'image(ALLOCATED_MEMORY_RANGE)
  severity ERROR;
  assert ((4*17) > ALLOCATED_MEMORY_RANGE)
    report "CM_FW_INFO: Regmap addressing range " & integer'image(4*17) & " is inside of AXI mapped range " & integer'image(ALLOCATED_MEMORY_RANGE)
  severity NOTE;
