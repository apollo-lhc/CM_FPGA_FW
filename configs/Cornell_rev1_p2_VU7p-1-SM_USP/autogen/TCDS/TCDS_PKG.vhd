...
package TCDS_CTRL is
  ...
  type TCDS_RESET_CTRL_t is record
    RESET_ALL                  :std_logic;   
    ...
    DRP                        :std_logic;   
  end record TCDS_RESET_CTRL_t;


  constant DEFAULT_TCDS_RESET_CTRL_t : TCDS_RESET_CTRL_t := (
                                                             RESET_ALL => '0',
  ...
  type TCDS_STATUS_MON_t is record
  ...
  end record TCDS_STATUS_MON_t;


  type TCDS_DEBUG_RX_MON_t is record
  ...
  end record TCDS_DEBUG_RX_MON_t;


  type TCDS_DEBUG_RX_CTRL_t is record
  ...
  end record TCDS_DEBUG_RX_CTRL_t;


  constant DEFAULT_TCDS_DEBUG_RX_CTRL_t : TCDS_DEBUG_RX_CTRL_t := (
                                                                   BUF_RESET => '0',
                                                                   CDR_HOLD => '0',
                                                                   DFE_LPM_RESET => '0',
                                                                   LPM_EN => '1',
  ...
  type TCDS_DEBUG_TX_MON_t is record
    BUF_STATUS                 :std_logic_vector( 1 downto 0);  -- DEBUG tx buf status
    RESET_DONE                 :std_logic;                      -- DEBUG tx reset done
  end record TCDS_DEBUG_TX_MON_t;


  type TCDS_DEBUG_TX_CTRL_t is record
  ...
  end record TCDS_DEBUG_TX_CTRL_t;


  constant DEFAULT_TCDS_DEBUG_TX_CTRL_t : TCDS_DEBUG_TX_CTRL_t := (
                                                                   INHIBIT => '0',
                                                                   PCS_RESET => '0',
                                                                   PMA_RESET => '0',
                                                                   POLARITY => '0',
  ...
  type TCDS_DEBUG_MON_t is record
    ...
    RX                         :TCDS_DEBUG_RX_MON_t;          
    TX                         :TCDS_DEBUG_TX_MON_t;          
  ...
  type TCDS_DEBUG_CTRL_t is record
    ...
    RX                         :TCDS_DEBUG_RX_CTRL_t;         
    TX                         :TCDS_DEBUG_TX_CTRL_t;         
  end record TCDS_DEBUG_CTRL_t;


  constant DEFAULT_TCDS_DEBUG_CTRL_t : TCDS_DEBUG_CTRL_t := (
                                                             EYESCAN_RESET => '0',
                                                             EYESCAN_TRIGGER => '0',
                                                             PCS_RSV_DIN => (others => '0'),
                                                             RX => DEFAULT_TCDS_DEBUG_RX_CTRL_t,
                                                             TX => DEFAULT_TCDS_DEBUG_TX_CTRL_t
                                                            );
  ...
  constant DEFAULT_TCDS_TX_CTRL_t : TCDS_TX_CTRL_t := (
                                                       CTRL0 => (others => '0'),
                                                       CTRL1 => (others => '0'),
                                                       CTRL2 => (others => '0'),
                                                       RESET => '0'
  ...
  constant DEFAULT_TCDS_RX_CTRL_t : TCDS_RX_CTRL_t := (
                                                       RESET => '0'
                                                      );
  type TCDS_DATA_CTRL_MON_t is record
    CAPTURE_D                  :std_logic_vector(31 downto 0);
    CAPTURE_K                  :std_logic_vector( 3 downto 0);
  end record TCDS_DATA_CTRL_MON_t;
  ...
  constant DEFAULT_TCDS_DATA_CTRL_CTRL_t : TCDS_DATA_CTRL_CTRL_t := (
                                                                     CAPTURE => '0',
                                                                     MODE => (others => '0'),
                                                                     FIXED_SEND_D => (others => '0'),
                                                                     FIXED_SEND_K => (others => '0')
                                                                    );
  type TCDS_DRP_MOSI_t is record
    clk       : std_logic;
    enable    : std_logic;
    wr_enable : std_logic;
    address   : std_logic_vector(10-1 downto 0);
    wr_data   : std_logic_vector(16-1 downto 0);
  end record TCDS_DRP_MOSI_t;
  type TCDS_DRP_MISO_t is record
    rd_data         : std_logic_vector(16-1 downto 0);
    rd_data_valid   : std_logic;
  end record TCDS_DRP_MISO_t;
  constant Default_TCDS_DRP_MOSI_t : TCDS_DRP_MOSI_t := ( 
                                                     clk       => '0',
                                                     enable    => '0',
                                                     wr_enable => '0',
                                                     address   => (others => '0'),
  ...
  type TCDS_MON_t is record
    ...
    STATUS                     :TCDS_STATUS_MON_t;  
    DEBUG                      :TCDS_DEBUG_MON_t;   
    TX                         :TCDS_TX_MON_t;      
    RX                         :TCDS_RX_MON_t;      
    DATA_CTRL                  :TCDS_DATA_CTRL_MON_t;
    DRP                        :TCDS_DRP_MISO_t;     
  end record TCDS_MON_t;


  type TCDS_CTRL_t is record
    RESET                      :TCDS_RESET_CTRL_t;
    DEBUG                      :TCDS_DEBUG_CTRL_t;
    TX                         :TCDS_TX_CTRL_t;   
    RX                         :TCDS_RX_CTRL_t;   
    DATA_CTRL                  :TCDS_DATA_CTRL_CTRL_t;
  ...
  constant DEFAULT_TCDS_CTRL_t : TCDS_CTRL_t := (
                                                 RESET => DEFAULT_TCDS_RESET_CTRL_t,
                                                 DEBUG => DEFAULT_TCDS_DEBUG_CTRL_t,
                                                 TX => DEFAULT_TCDS_TX_CTRL_t,
                                                 RX => DEFAULT_TCDS_RX_CTRL_t,
                                                 DATA_CTRL => DEFAULT_TCDS_DATA_CTRL_CTRL_t,
                                                 TXRX_CLK_SEL => '0',
                                                 LOOPBACK => (others => '0'),
                                                 DRP => Default_TCDS_DRP_MOSI_t
                                                );
