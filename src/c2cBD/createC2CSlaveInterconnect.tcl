...
set_property CONFIG.SupportLevel         {1}          [get_bd_cells ${C2CB_PHY}]
...
make_bd_pins_external       -name ${C2CB_PHY}_user_clk_out   [get_bd_pins ${C2CB_PHY}/user_clk_out]
...
connect_bd_net [get_bd_pins ${C2CB_PHY}/user_clk_out]        [get_bd_pins ${C2CB}/axi_c2c_phy_clk]
connect_bd_net [get_bd_pins ${C2CB_PHY}/channel_up]          [get_bd_pins ${C2CB}/axi_c2c_aurora_channel_up]
connect_bd_net [get_bd_pins ${C2CB_PHY}/mmcm_not_locked_out] [get_bd_pins ${C2CB}/aurora_mmcm_not_locked]
